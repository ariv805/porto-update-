...
interface GalleryItem {
  ...
  color: string;
  // Tambahkan path gambar di sini, contoh: "/images/gallery/lab-jaringan.jpg"
  image?: string;
}
              ...
              {filteredItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {/* Image */}
                      <div className={`relative h-48 ${item.image && item.image.length > 0 ? '' : `bg-gradient-to-br ${item.color}`} overflow-hidden`}>
            ...
            {selectedItem && (
              ...
              >
                ...
                >
                  ...
                  {/* Modal Content */}
                  <div className={`relative h-80 ${selectedItem.image && selectedItem.image.length > 0 ? '' : `bg-gradient-to-br ${selectedItem.color}`} flex items-center justify-center overflow-hidden`}>
