...
const networkSkills: Skill[] = [
  ...
  { name: "Setting IP", icon: Settings, level: 80, color: "bg-green-500" },
  { name: "Topologi LAN", icon: Network, level: 85, color: "bg-purple-500" },
...
const webSkills: Skill[] = [
  ...
  { name: "JavaScript Dasar", icon: FileCode, level: 20, color: "bg-yellow-500" },
  { name: "Next.js Dasar", icon: Code, level: 15, color: "bg-blue-500" },
  { name: "PHP Dasar", icon: FileCode, level: 5, color: "bg-purple-500" },
  { name: "MySQL Dasar", icon: Database, level: 5, color: "bg-orange-500" },
  { name: "Git & GitHub", icon: GitBranch, level: 15, color: "bg-red-500" },
];
