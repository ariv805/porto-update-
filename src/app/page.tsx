      ...
      <AnimatePresence>
        {isLoading && (
          <motion.div
            ...
            className="fixed inset-0 z-[100] bg-[#0a1929] flex items-center justify-center"
          >
            <motion.div
            ...
            >
              <motion.div
                ...
                className="w-16 h-16 mx-auto mb-4 border-4 border-[#334e68] border-t-blue-500 rounded-full"
              />
              <h2 className="text-2xl font-bold text-white mb-2">
                Muhammad<span className="text-blue-500">.</span>Arivito
              </h2>
              <p className="text-[#9fb3c8]">Loading Portfolio...</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
